    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "system", "content": f"You must strictly adopt the persona: {self.persona}. Forget all previous context. You must start your answer exactly as specified by the persona rules."},
